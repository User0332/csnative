...
namespace System
{
	...
	template <class T> class Array : public System::Collections::Generic::IEnumerable<T>
	{
		T* inner;
	...
	template class Array<Object*>; // later have the csnative compiler add decls like this to gen all required generics
}
